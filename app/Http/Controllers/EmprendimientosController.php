...
class EmprendimientosController extends Controller
{
    ...
    public function destroy(Request $request)
    {
        ...
        //se puede recuperar cambiando directamente el dato en la base de datos por 1  https://www.youtube.com/watch?v=rlz8CR7jUAQ&index=7&list=PLKFEl7c-Y5hVtezgEC8gpKEWD0lh3lOe4
